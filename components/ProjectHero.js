...
const ProjectHero = () => {
    return (
        <div className='p-5'>
            <h1 className='text-white capitalize text-3xl md:text-4xl font-black text-center'>Here&apos;s a list of all the <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#4AA4FF] to-[#B575F7]'>projects</span> I&apos;ve worked on so far</h1>
            <ProjectComp />
