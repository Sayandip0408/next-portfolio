    ...
    return (
        <div className='p-5'>
            ...
            <div className='lg:w-[70vw] mx-auto mt-5'>
                ...
                <p className='text-white text-lg text-justify my-2 indent-8 md:indent-0'>I am a frontend developer eager to continue learning and growing in the tech industry. My short-term goal is to contribute meaningfully to a reputed organization that provides opportunities to enhance my skills and knowledge. In the long term, I aspire to achieve a leadership role within the same organization, contributing to its growth and success.</p>
                <p className='text-white text-lg text-justify my-2 indent-8 md:indent-0'>I pride myself on being highly adaptable to new environments and challenges, enabling me to thrive in dynamic situations and deliver impactful results.</p>
                <p className='text-white text-lg text-justify my-2 indent-8 md:indent-0'>I have a passion for <Link href='https://shutter-island.netlify.app/' target='_blank' className='font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#4AA4FF] to-[#B575F7] hover:underline decoration-[#B575F7]'>photography </Link> and enjoy playing cricket. In my leisure time, I love immersing myself in movies and TV shows, which help me relax and recharge.</p>
            </div>
