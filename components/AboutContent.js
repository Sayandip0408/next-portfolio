    ...
    return (
        <div className='p-5'>
            ...
            <div className='lg:w-[70vw] mx-auto mt-5'>
                ...
                <p className='text-white text-lg text-justify my-2 indent-8 md:indent-0'>My short term goal is to get placed in a reputed company, which allows me to enhance my skills and knowledge. My long term goal would be to reach a higher position in the same company. My strength is that I can adapt quickly to any environment.</p>
                <p className='text-white text-lg text-justify my-2 indent-8 md:indent-0'>My hobbies are <Link href='https://shutter-island.netlify.app/' target='_blank' className='font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#4AA4FF] to-[#B575F7] hover:underline decoration-[#B575F7]'>photography </Link> and playing cricket. I also love watching movies and TV shows in my leisure.</p>
            </div>
