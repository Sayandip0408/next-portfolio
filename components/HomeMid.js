...
const HomeMid = () => {
    return (
        <div className='py-4 px-4 md:px-0'>
            <motion.h2 initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ delay: 0.5, duration: 1 }} className='text-white text-2xl md:text-3xl font-semibold text-center mb-3'>I <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#4AA4FF] to-[#B575F7]'>LOVE</span> TO CREATE SOMETHING SIMPLE AND CLEAN <AiFillHeart className='text-[#B575F7] inline mt-[-5px] animate-bounce' /></motion.h2>
            <div className='mt-10'>
                <motion.div initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className='h-[fit-content] w-[fit-content] p-[2px] mx-auto rounded-lg card'>
                    <Image
